...
# elif you're using an existing DB, then just pass the path to all the other functions

# useful functions:
# - add_verse_tag, add_verse_note, add_tag_note, add_tag_tag 
#   = add data to the DB
# - delete_verse_tag, delete_verse_note, etc. 
#   = to delete data 
# - get_db_stuff 
#   = for general purpose data-getting. 
#   = e.g. to get all tags for genesis 1:1, you would get_db_stuff(dbpath, "tag", "verse", "Genesis 1:1")
# - find_note_tag_verses
#   = to get a list of all verse ranges intersecting a given chapter, which have tags or notes
